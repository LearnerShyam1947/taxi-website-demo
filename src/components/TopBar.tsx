  ...
  return (
    <div className={`topbar  bg-yellow-500 shadow-md z-30 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
      <div className="flex justify-between items-center p-2">
        <div className="address text-gray-700 text-sm">19-49-s9-1860 varshitha towers, flat Num 203 postal colony, 7th cross Tirupathi-517501</div>
        <div className="right flex items-center space-x-4">
          ...
          <span className="phone-number text-gray-600 text-sm">+91 9966 1111 20</span>
        </div>
      </div>
    </div>
  );
